...
*	@class com.boneyard.annotation.engine.parser.Tokenizer
*
*	@requires underscore
...
class Tokenizer extends EventEmitter {
	...
	*	@return com.boneyard.annotation.engine.parser.Tokenizer
	**/
	constructor(input) {
		super();
		this.cur = -1;
	...
	**/
	static get Events() {
		return {
			next: 'com:boneyard:annotation:engine:parser:tokenizer:next',
			remove: 'com:boneyard:annotation:engine:parser:tokenizer:remove'
		};
	}
