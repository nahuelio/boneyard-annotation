...
var EventEmitter = require('events').EventEmitter,
	Scanner = require(process.env.LIB_PATH + 'com/boneyard/annotation/scanner'),
	Runner = require(process.env.LIB_PATH + 'com/boneyard/annotation/commands/runner'),
...
describe('com.boneyard.annotation.Scanner', function() {
