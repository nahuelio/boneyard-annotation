...
var Tokenizer = require(process.env.LIB_PATH + 'com/boneyard/annotation/engine/parser/tokenizer');

describe('com.boneyard.annotation.engine.parser.Tokenizer', function() {
